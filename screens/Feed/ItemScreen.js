...
const ItemScreen = ({ navigation, route }) => {
  ...
  return (
    <SafeAreaView className="flex-1 items-center bg-[#FFF982]">
      ...
      <View style={{backgroundColor: levelToColor[itemData.fat_level] || 'gray'}} className="border-2 border-black flex-1 rounded-2xl shadow-neo p-2 justify-center items-center">
      ...
      <View style={{backgroundColor: levelToColor[itemData.saturated_fat_level] || 'gray'}} className="border-2 border-black flex-1 rounded-2xl shadow-neo p-2 justify-center items-center">
      ...
      <View className="w-full flex-row space-x-4">
      <View style={{backgroundColor: levelToColor[itemData.sugar_level] || 'gray'}} className="border-2 border-black flex-1 rounded-2xl shadow-neo p-2 justify-center items-center">
      ...
      <View style={{backgroundColor: levelToColor[itemData.salt_level] || 'gray'}} className="border-2 border-black flex-1 rounded-2xl shadow-neo p-2 justify-center items-center">
